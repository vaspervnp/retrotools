...
> **Γλώσσα:** Ελληνικά · [English](README.md)
...
> **392 tests πράσινα**, 82 πάνω σε πραγματική MariaDB.
> Δες το [plan.el.md](plan.el.md) για τη μελέτη και ό,τι απομένει.
...
| Έγγραφο | Τι καλύπτει |
|---|---|
| [**Εγχειρίδιο χρήσης**](docs/manual.el.md) | Πώς χρησιμοποιείται: πλατφόρμες, editor, spritemaps, export |
| [Ρύθμιση OAuth](docs/oauth-setup.el.md) | Δημιουργία των κλειδιών GitHub και Google, βήμα-βήμα |
| [plan.el.md](plan.el.md) | Μελέτη υλικού, αρχιτεκτονική, κάθε απόφαση και το γιατί |
...
Αναλυτικά (bit layouts, διευθύνσεις μνήμης, πίνακες χρωμάτων): [plan.md §3](plan.el.md).
...
> αναβάθμιση θα σπάσει τον provider στο runtime. Δες [plan.md §2](plan.el.md).
...
**➜ [Αναλυτικές οδηγίες: docs/oauth-setup.md](docs/oauth-setup.el.md)** — βήμα-βήμα
...
Φάσεις M0 → M8, αναλυτικά στο [plan.md §10](plan.el.md). Συνοπτικά:
