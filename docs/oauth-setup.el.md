...
> **Γλώσσα:** Ελληνικά · [English](oauth-setup.md)
...
> Δες [Τοπική σύνδεση χωρίς OAuth](../README.el.md#τοπική-σύνδεση-χωρίς-oauth).
...
Με το [`retrotools-secrets`](../README.el.md#ρύθμιση-σε-server-χωρίς-net-sdk):
...
| Το callback καταλήγει σε `http://` πίσω από proxy | Λείπει το `BehindReverseProxy: true` ή τα `KnownProxies`· δες [Deployment](../README.el.md#deployment) |
